package com.github.nezxenka.darkbot.config.tree;

import com.github.nezxenka.darkbot.config.tree.handlers.SettingHandlerFactory;
...
public class ConfigBuilder implements API.Singleton {
    ...
    public <T> ConfigSetting.Parent<T> of(Class<T> type, String rootName, @Nullable PluginInfo namespace) {
        ...
        if (cfg != null) {
            ...
            com.github.nezxenka.darkbot.config.types.Option legacyOption =
                    type.getAnnotation(com.github.nezxenka.darkbot.config.types.Option.class);
    ...
    private class Builder {
        ...
        private ConfigSetting<?> createConfig(ConfigSetting.Parent<?> parent, String parentKey, Field field) {
            ...
            com.github.nezxenka.darkbot.config.types.Option legacyOption
                    = field.getAnnotation(com.github.nezxenka.darkbot.config.types.Option.class);
        ...
        private boolean participates(Field field) {
            ...
            if (field.isAnnotationPresent(com.github.nezxenka.darkbot.config.types.Option.class)) return true;
