package com.github.nezxenka.darkbot.config.tree.handlers;

import com.github.nezxenka.darkbot.config.Config;
import com.github.nezxenka.darkbot.config.types.Length;
import com.github.nezxenka.darkbot.config.types.Num;
import com.github.nezxenka.darkbot.config.types.Placeholder;
...
public class SettingHandlerFactory implements API.Singleton {
    ...
    public SettingHandlerFactory(PluginAPI api) {
        root.add(new Parent(type(int.class, double.class, Integer.class, Double.class))
                ...
                .add(new Parent(type(PlayerTag.class, com.github.nezxenka.darkbot.config.PlayerTag.class))
                        .add(annot(Tag.class), PlayerTagHandler::of)
                        .add(annot(com.github.nezxenka.darkbot.config.types.Tag.class), PlayerTagHandler::ofLegacy)
