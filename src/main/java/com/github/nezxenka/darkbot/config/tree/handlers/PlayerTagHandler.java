...
import com.github.nezxenka.darkbot.config.types.TagDefault;
...
public class PlayerTagHandler extends DefaultHandler<PlayerTag> {
    ...
    public static PlayerTagHandler ofLegacy(Field field) {
        com.github.nezxenka.darkbot.config.types.Tag legacyTag =
                field.getAnnotation(com.github.nezxenka.darkbot.config.types.Tag.class);
