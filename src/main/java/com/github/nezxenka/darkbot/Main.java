package com.github.nezxenka.darkbot;
...
import com.github.nezxenka.darkbot.config.ConfigManager;
import com.github.nezxenka.darkbot.config.utils.ByteArrayToBase64TypeAdapter;
import com.github.nezxenka.darkbot.config.utils.ConditionTypeAdapterFactory;
import com.github.nezxenka.darkbot.config.utils.PlayerTagTypeAdapterFactory;
import com.github.nezxenka.darkbot.config.utils.SpecialTypeAdapter;
import com.github.nezxenka.darkbot.core.BotInstaller;
import com.github.nezxenka.darkbot.core.IDarkBotAPI;
import com.github.nezxenka.darkbot.core.api.Capability;
import com.github.nezxenka.darkbot.core.api.InvalidNativeSignature;
import com.github.nezxenka.darkbot.core.manager.EffectManager;
import com.github.nezxenka.darkbot.core.manager.FacadeManager;
import com.github.nezxenka.darkbot.core.manager.GuiManager;
import com.github.nezxenka.darkbot.core.manager.HeroManager;
import com.github.nezxenka.darkbot.core.manager.MapManager;
import com.github.nezxenka.darkbot.core.manager.PerformanceManager;
import com.github.nezxenka.darkbot.core.manager.PingManager;
import com.github.nezxenka.darkbot.core.manager.RepairManager;
import com.github.nezxenka.darkbot.core.manager.SettingsManager;
import com.github.nezxenka.darkbot.core.manager.StarManager;
import com.github.nezxenka.darkbot.core.manager.StatsManager;
import com.github.nezxenka.darkbot.core.utils.Lazy;
import com.github.nezxenka.darkbot.extensions.DarkBotPluginApiImpl;
...
import com.github.nezxenka.darkbot.extensions.plugins.PluginIssue;
import com.github.nezxenka.darkbot.extensions.plugins.PluginListener;
import com.github.nezxenka.darkbot.extensions.plugins.PluginUpdater;
import com.github.nezxenka.darkbot.extensions.util.VerifierChecker;
import com.github.nezxenka.darkbot.extensions.util.Version;
import com.github.nezxenka.darkbot.gui.MainGui;
import com.github.nezxenka.darkbot.gui.utils.Popups;
import com.github.nezxenka.darkbot.modules.DisconnectModule;
import com.github.nezxenka.darkbot.modules.DummyExceptionModule;
import com.github.nezxenka.darkbot.modules.DummyModule;
import com.github.nezxenka.darkbot.utils.I18n;
import com.github.nezxenka.darkbot.utils.StartupChecks;
import com.github.nezxenka.darkbot.utils.StartupParams;
import com.github.nezxenka.darkbot.utils.Time;
...
public class Main extends Thread implements PluginListener, BotAPI {
    ...
    public com.github.nezxenka.darkbot.core.itf.Module module; // Legacy module, kept for old plugin compatibility
    ...
    @Deprecated
    public <A extends com.github.nezxenka.darkbot.core.itf.Module> A setModule(A module) {
    ...
    private <A extends Module> A setModule(A module, boolean setConfig) {
        ...
        this.module = module instanceof com.github.nezxenka.darkbot.core.itf.Module ?
                (com.github.nezxenka.darkbot.core.itf.Module) module : new DummyModule();
        return module;
    }
