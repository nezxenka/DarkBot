...
import com.github.nezxenka.darkbot.config.LegacyShipMode;
...
import com.github.nezxenka.darkbot.extensions.features.handlers.ShipModeSelectorHandler;
...
import static com.github.nezxenka.darkbot.core.objects.facades.SettingsProxy.KeyBind.ATTACK_LASER;
import static com.github.nezxenka.darkbot.core.objects.facades.SettingsProxy.KeyBind.ATTACK_ROCKET;
import static com.github.nezxenka.darkbot.core.objects.facades.SettingsProxy.KeyBind.JUMP_GATE;
import static com.github.nezxenka.darkbot.core.objects.facades.SettingsProxy.KeyBind.TOGGLE_CONFIG;
...
public class HeroManager extends Player implements Manager, HeroAPI {
    ...
    @Deprecated
    public void jumpPortal(com.github.nezxenka.darkbot.core.entities.Portal portal) {
