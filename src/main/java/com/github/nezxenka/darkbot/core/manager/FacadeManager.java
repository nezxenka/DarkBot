package com.github.nezxenka.darkbot.core.manager;

import com.github.nezxenka.darkbot.core.BotInstaller;
import com.github.nezxenka.darkbot.core.itf.Manager;
import com.github.nezxenka.darkbot.core.itf.Updatable;
import com.github.nezxenka.darkbot.core.objects.facades.AssemblyMediator;
import com.github.nezxenka.darkbot.core.objects.facades.AstralGateProxy;
import com.github.nezxenka.darkbot.core.objects.facades.BoosterProxy;
import com.github.nezxenka.darkbot.core.objects.facades.ChatProxy;
import com.github.nezxenka.darkbot.core.objects.facades.ChrominProxy;
import com.github.nezxenka.darkbot.core.objects.facades.DiminishQuestMediator;
import com.github.nezxenka.darkbot.core.objects.facades.DispatchGateProxy;
import com.github.nezxenka.darkbot.core.objects.facades.DispatchProxy;
import com.github.nezxenka.darkbot.core.objects.facades.DispatchRetrieverProxy;
import com.github.nezxenka.darkbot.core.objects.facades.EscortProxy;
import com.github.nezxenka.darkbot.core.objects.facades.EternalBlacklightProxy;
import com.github.nezxenka.darkbot.core.objects.facades.EternalGateProxy;
import com.github.nezxenka.darkbot.core.objects.facades.FrozenLabyrinthProxy;
import com.github.nezxenka.darkbot.core.objects.facades.GalaxyBuilderProxy;
import com.github.nezxenka.darkbot.core.objects.facades.GauntletPlutusProxy;
import com.github.nezxenka.darkbot.core.objects.facades.HighlightProxy;
import com.github.nezxenka.darkbot.core.objects.facades.InventoryProxy;
import com.github.nezxenka.darkbot.core.objects.facades.LogMediator;
import com.github.nezxenka.darkbot.core.objects.facades.NpcEventProxy;
import com.github.nezxenka.darkbot.core.objects.facades.SeassonPassMediator;
import com.github.nezxenka.darkbot.core.objects.facades.QuestProxy;
import com.github.nezxenka.darkbot.core.objects.facades.SettingsProxy;
import com.github.nezxenka.darkbot.core.objects.facades.ShipWarpProxy;
import com.github.nezxenka.darkbot.core.objects.facades.SlotBarsProxy;
import com.github.nezxenka.darkbot.core.objects.facades.SpaceMapWindowProxy;
import com.github.nezxenka.darkbot.core.objects.facades.StatsProxy;
import com.github.nezxenka.darkbot.core.objects.facades.WorldBossOverviewProxy;
import com.github.nezxenka.darkbot.core.objects.swf.FlashMap;
