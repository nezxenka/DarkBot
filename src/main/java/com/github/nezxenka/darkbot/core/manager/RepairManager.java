...
import com.github.nezxenka.darkbot.core.objects.SpriteObject;
import com.github.nezxenka.darkbot.core.objects.swf.FlashListInt;
import com.github.nezxenka.darkbot.core.objects.swf.FlashListLong;
import com.github.nezxenka.darkbot.core.utils.ByteUtils;
import com.github.nezxenka.darkbot.extensions.features.handlers.ReviveSelectorHandler;
import com.github.nezxenka.darkbot.utils.LogUtils;
...
public class RepairManager implements Manager, RepairAPI {
    ...
    public static class DefaultReviveSupplier implements ReviveSelector, PrioritizedSupplier<ReviveLocation> {
        ...
        private final ConfigSetting<com.github.nezxenka.darkbot.config.types.suppliers.ReviveLocation> reviveLocation;
