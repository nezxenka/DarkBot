package com.github.nezxenka.darkbot.extensions.features.decorators;
...
public class InstructionProviderDecorator extends FeatureDecorator<InstructionProvider> {
    ...
    public static void showInstructions(Object featureInstance, String name) {
        ...
        if (featureInstance instanceof com.github.nezxenka.darkbot.core.itf.InstructionProvider) {
            ((com.github.nezxenka.darkbot.core.itf.InstructionProvider) featureInstance).showInstructions(name);
            return;
        }
