package com.github.nezxenka.darkbot.gui.drawables;
...
public class ZonesDrawer implements Drawable {
    ...
    public void drawCustomZonePath(MapGraphics mg, ZoneInfo zoneInfo) {
        if (!(zoneInfo instanceof com.github.nezxenka.darkbot.config.ZoneInfo)) return;

        List<com.github.nezxenka.darkbot.config.ZoneInfo.Zone> sortedZones =
                ((com.github.nezxenka.darkbot.config.ZoneInfo) zoneInfo).getSortedZones();
